 ...
 * @returns Promise resolving to the chosen update type or 'back'
 */
  ...
  while (continueRunning) {
    ...
    try {
      ...
      if (choices.updateType === 'append') {
        ...
        continueRunning = false; // Exit after processing
      } else if (choices.updateType === 'summarize') {
